...
{
    public sealed partial class GabyLightCycleSystem : EntitySystem
    {
        ...
        {
            EnsureComp<GabyLightCycleComponent>(ent);
            _entityManager.GetComponent<GabyLightCycleComponent>(ent).IsEnabled = _configuration.GetCVar(CCVars.CycleEnabled);
            _entityManager.GetComponent<GabyLightCycleComponent>(ent).IsColorShiftEnabled = _configuration.GetCVar(CCVars.ColorEnabled);
            _entityManager.GetComponent<GabyLightCycleComponent>(ent).IsAnnouncementEnabled = _configuration.GetCVar(CCVars.AnnouncementEnabled);
        }
        ...
        public Color GetCycleColor(GabyLightCycleComponent comp, Color color)
        {
        ...
        public double CalculateLightLevel(GabyLightCycleComponent comp)
        {
        ...
        public double[] CalculateColorLevel(GabyLightCycleComponent comp)
        {
            var wave_lenght = Math.Max(0, comp.CycleDuration) * 24;
            var time = GetStationTime();
