...
particle-accelerator-control-menu-status-label = Estado:
...
particle-accelerator-control-menu-draw-not-available = Puxar:
particle-accelerator-control-menu-draw = Puxar:
